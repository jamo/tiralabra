...
class OldBinomialHeap
  ...
  def insert value, key
    ...
    new_heap = OldBinomialHeap.new new_node, 1
...
# @param [Object] new_value
  ...
  def remove_min
    ...
    new_heap = OldBinomialHeap.new(reverse(min_curr.child))
    curr = new_heap.root
    while curr != nil
      curr.parent = nil
      curr = curr.sibling
  ...
  def union h1, h2
    h = OldBinomialHeap.new(merge(h1, h2), 0)
    if h.root == nil
      return h
    end
